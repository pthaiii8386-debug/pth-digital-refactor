...
async function callTinOtp(path, method = 'GET', params = {}, body = null) {
  if (!TINOTP_API_KEY) {
    throw new Error('Thiếu TINOTP_API_KEY trong môi trường.');
  }
